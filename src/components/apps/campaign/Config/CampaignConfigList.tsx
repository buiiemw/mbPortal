...
import { getCampaignConfig, CampaignConfig } from '@app/api/campaign.api';
...
export const CampaignConfigList: React.FC = () => {
  const [form] = Form.useForm();
  const [tableData, setTableData] = useState<{ data?: CampaignConfig[]; loading: boolean }>({
    data: [],
    loading: false,
  });
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'defaultCampaignValue',
      width: '30%',
      editable: true,
    },
    {
